...
# lista.pop() #el metodo .pop elimina el ultimo elemento de la lista

# lista.remove("hola") #el metodo .remove elimina el dato ingresado

# print(lista)


lista.reverse() #voltea la lista
lista.sort() #No se puede usar cuando tenemos diferentes tipos de datos
print(lista)